...
>-There are also many ['cheatsheets'](https://www.rstudio.com/resources/cheatsheets/) available that gives you the need-to-know information on some of the most populat packages. Some can be found under <strong>Help > Cheatsheets</strong>
...
- calculate the monthly instalment as:  
...
- calculate a probability of default termstructure as:  
